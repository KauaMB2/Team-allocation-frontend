...
const Employees = ({handleEditEmployee, handleDelete, employees, selectedTeam, handleEmployeeCardClick, handleTeamSelectionChange, setShowTrashModal, showTrashModal, showEditModal, setShowEditModal}) => {
  return (
    <>
      <Header 
